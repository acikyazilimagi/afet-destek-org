...
class TextThemeDark {
  ...
  final TextStyle headline1 = const TextStyle(
      fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, fontSize: 96, letterSpacing: -1.5);
  final TextStyle headline2 = const TextStyle(
      fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, letterSpacing: -0.5, fontSize: 60);
  final TextStyle headline3 =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, fontSize: 48);
  final TextStyle headline4 = const TextStyle(
      fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, letterSpacing: 0.25, fontSize: 34);
  final TextStyle headline5 =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, fontSize: 24);
  final TextStyle headline6 =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontWeight: FontWeight.w600, fontSize: 16);
  final TextStyle subtitle2 = const TextStyle(
      fontFamily: ApplicationConstants.FONT_FAMILY, fontSize: 14, fontWeight: FontWeight.w400, letterSpacing: 0.5);
  final TextStyle subtitle1 = const TextStyle(
      fontFamily: ApplicationConstants.FONT_FAMILY, fontSize: 14, fontWeight: FontWeight.w400, letterSpacing: 0.5);
  final TextStyle button =
      const TextStyle(fontFamily: ApplicationConstants.FONT_FAMILY, fontSize: 16, fontWeight: FontWeight.w600);
